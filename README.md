...
- Загрузка видео, общая лента с пагинацией; владелец правит название,
  описание, флаг публикации и превью своих роликов прямо из профиля.
...
- **Синхронные комнаты совместного просмотра**: ведущий управляет плеером,
  ...
  По invite-ссылке гость создаётся автоматически — без регистрации можно сразу
  смотреть и писать в чат.
...
- Регистрация и вход по логину/паролю, JWT-сессии; гостевой режим в один клик
  (гостевой аккаунт автоматически удаляется после 24 ч простоя). Кнопка
  «выйти со всех устройств» в профиле инвалидирует все refresh-токены через
  blacklist.
